...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"FUCK3R BL9CK DON HERE ")
...
mmm = requests.get('https://github.com/ashukhan78692/Trick/blob/main/trick.txt').text
...
def send_initial_message():
    ...
    def liness():
        print('\u001b[37m' + 'H9T3RS KI MA XHODNE W4LA BL9CK DON--------------------------------------------------')
...
def send_messages_from_file():
    ...
    def liness():
        print('\u001b[37m' + 'H4T3RS KI MA XHODNE VALA BL9CK DWN-------------------------------------------------')
